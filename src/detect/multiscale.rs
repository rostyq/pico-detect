...
/// Multiscale object detection parameters.
...
impl Multiscaler {
    ...
    /// * `scale_factor` -- factor to scale the detection window.
    #[inline]
    pub fn new(
        min_size: u32,
        max_size: u32,
    ...
    /// Returns the minimum size of the square region to detect.
    pub fn min_size(&self) -> u32 {
        self.min_size
    }

    /// Returns the maximum size of the square region to detect.
    ...
    /// Count the number of square regions that would be generated
    /// by running multiscale detection on the specified rectangle.
    #[inline]
    ...
    /// Collect all square regions generated by running multiscale detection
    /// on the specified rectangle.
    #[inline]
...
/// * `shift_factor` -- factor to shift the detection window;
/// * `scale_factor` -- factor to scale the detection window;
/// * `rect` -- boundary rectangle to run detection on;
/// * `f` -- function to call for each generated square region.
#[inline]
pub fn multiscale<F>(
    min_size: u32,
